...
<template>
    <div class="component-container">
        ...
        <div class="text-center h-full overflow-auto">
            ...
            <div class="flex h-[85%] justify-around">
            <div class="flex h-full flex-col w-[40%]">

                <transition name="fade" mode="out-in">
                    <div v-if="editting" class="h-[40%] w-full items-center justify-center">
                    ...
                    <div v-else class="h-[40%] w-full items-center justify-center">
                        <div class="h-[40%] flex items-center justify-center">
                            <h1 class="text-center text-2xl">Collection description: </h1>
                        </div>
                        <div class="h-[50%] black-bg text-left word-break overflow-auto">
                ...
                <transition name="fade" mode="out-in">
                    <div v-if="editting" class="h-[70%] w-full flex items-center justify-center">
                    ...
                    <div v-else class="h-[70%] w-full items-center justify-center">
                        <div class="flex items-center justify-center h-[10%]">
                            <h1 class="text-center text-2xl">Collection Labels:</h1>
                        </div>
                        <div class="h-[90%] black-bg overflow-auto">
            ...
            <div class="h-full w-[50%] items-center justify-center">
                ...
                <div class="h-[85%] black-bg overflow-auto">
                    <div class="grid grid-cols-3 mb-4 mx-[1%] space-x-[10%]" v-for="(item, index) in collection.items">
                        ...
                        <div class="text-xl text-center label-pure-black flex items-center justify-around">
                            <router-link
                                :to="{ name: 'View Item', params: { collectionid: collection.id, itemid: index, edit: 'edit' } }">
                                <font-awesome-icon icon="pen" class="link " />
                            </router-link>
                            <font-awesome-icon icon="trash" class="link hover:text-red-700" @click="deleteItem(index)" />
                        </div>
